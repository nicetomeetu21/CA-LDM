    ...
    def setup(self, stage=None):
        ...
        for cube_name in self.train_cube_names:
            ...
            for img_name in img_names:
                ...
                train_latent_pathes.append(os.path.join(self.latent_root, cube_name, img_name[:-4]+'.npy'))
        test_pathes = []
        test_latent_pathes = []
        for cube_name in self.test_cube_names:
            ...
            for img_name in img_names:
                ...
                test_latent_pathes.append(os.path.join(self.latent_root, cube_name, img_name[:-4]+'.npy'))
...
class img_latent_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img = cv.imread(self.img_pathes[index], cv.IMREAD_GRAYSCALE)
        ...
        return {'image': img, 'latent':latent, 'pre_image': pre_img, 'img_path': self.img_pathes[index],
