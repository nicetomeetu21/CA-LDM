...
class LinearAttention(nn.Module): # should be check
...
class Encoder(nn.Module):
    def __init__(self, *, ch, ch_mult=(1, 2, 4, 8), num_res_blocks,
                 ...
                 resolution, z_channels, double_z=False, use_linear_attn=False, attn_type="vanilla", **ignorekwargs):
        super().__init__()
...
class VectorQuantizer2(nn.Module):
    ...
    def forward(self, z, temp=None, rescale_logits=False, return_logits=False, testing=False):
    ...
    def get_codebook_entry(self, indices, shape):
        # shape specifying (batch, frame, height, width, channel)
        if self.remap is not None:
